...
public class MobileContactsApp {
                ...
                try {
                    ...
                    switch (choice) {
                        ...
                        case 3:
                            phoneNumber = getPhoneNumber();
                            printContactMenu();
                            updateController(getFirstname(), getLastname(), phoneNumber, getPhoneNumber());
    ...
    public static void updateContactService(String firstname, String lastname, String oldPhoneNumber, String newPhoneNumber) {
        try {
            if (!(update(firstname, lastname, oldPhoneNumber, newPhoneNumber))) {
    ...
    public static boolean update(String firstname, String lastname, String oldPhoneNumber, String newPhoneNumber) {
